...
import type { IdentifyStrainInput, IdentifyStrainOutput } from '@/app/identify/actions';
import { IdentifyStrainInputSchema, IdentifyStrainOutputSchema } from '@/app/identify/actions';
